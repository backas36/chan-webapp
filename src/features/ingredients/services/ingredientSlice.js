...
export const selectIngredientsTableConfig = (state) => state.ingredients
export const selectRowModesModel = (state) => state.ingredients.rowModesModel
export const selectCurrentRows = (state) => state.ingredients.rows
